 ...
 * - nativeGetDiagnostics 返回 LongArray(111)（= AQUA_DIAGNOSTICS_FIELD_COUNT），顺序见 AquaDiagnostics.fromArray；
...
object AquaNative {
    ...
    /** 诊断快照 LongArray(111)（= AQUA_DIAGNOSTICS_FIELD_COUNT）；handle 无效时返回 null。 */
