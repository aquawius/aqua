package com.aquawius.aqua.ui.theme
...
/** Aqua 品牌配色（teal 青绿系），作为默认与动态取色（Material You）的兜底。 */
...
private val AquaDarkColorScheme = darkColorScheme(
    primary = PrimaryDark,
