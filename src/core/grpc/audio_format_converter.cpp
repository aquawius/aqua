...
pb::AudioFormat to_proto(const AudioFormat& fmt)
{
    ...
    switch (fmt.encoding) {
    case AudioEncoding::PcmS16LE: proto_fmt.set_encoding(pb::AudioFormat::ENCODING_PCM_S16LE); break;
    case AudioEncoding::PcmS32LE: proto_fmt.set_encoding(pb::AudioFormat::ENCODING_PCM_S32LE); break;
    case AudioEncoding::PcmF32LE: proto_fmt.set_encoding(pb::AudioFormat::ENCODING_PCM_F32LE); break;
    case AudioEncoding::PcmS24LE: proto_fmt.set_encoding(pb::AudioFormat::ENCODING_PCM_S24LE); break;
    case AudioEncoding::PcmU8:    proto_fmt.set_encoding(pb::AudioFormat::ENCODING_PCM_U8);    break;
    default: proto_fmt.set_encoding(pb::AudioFormat::ENCODING_INVALID); break;
    }
